 ...
 * Notifications appear in the top-right corner with automatic removal.
 */
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <button
              ...
              className={`flex-shrink-0 inline-flex ${getTextColor(notification.type)} hover:opacity-75 transition-opacity`}
